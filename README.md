...
- 📚 **Python Institute – PCPP1: Certified Professional in Python Programming (In Progress)**  
  Completed coursework: Python Essentials 1, Python Essentials 2, Advanced Object-Oriented Programming, File Processing, Best Practices, Working with RESTful APIs, GUI Programming
